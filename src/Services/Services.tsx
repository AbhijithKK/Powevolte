  ...
  return (
    ...
    <div style={{
      ...
      <div className="service">
        <div className="s-left">
            <div>Battery</div>
            <p>Power Volte is a leading battery supplier in Orkatteri, Kerala. We deal with renowned battery brands such as Exide, Amaron, Luminous, Hi-Power, Prestolite, SF Sonic, Roots, Powersun, Power Box, and Su-Kam. Power Volte introduces an exclusive service designed to handle auto electrical emergencies. If you encounter start-up problems, battery failures, or UPS breakdowns, don't worry! Just give us a call, and we'll provide you with the support you need. Experience the reliability of Power Volte for all your power solutions.</p>
        </div>
        <div className="s-right">
